var Conch = {
	...
	'Swiper': {
        'Init': function() {
            $.getScript(maccms.path + "/statics/js/set/swiper.min.js", function() {
    ...
    'Search': {
        ...
        'Suggest':function($obj,$mid){
            $.getScript(maccms.path + "/statics/js/set/autocomplete.js",function(){
    ...
    'Other':{
        ...
        'Color': function() {
			...
			$(".hl-color-item a").click(function(){
                ...
                $("link[name='color']").attr("href","/statics/css/"+$Color+".css?v="+conchtpl.ver+"");  
