...
jQuery.showfloatdiv = function (ox) {
  ...
  if (oxdefaults.wantclose == 1) {
    var floatdiv = $(
      '<div class="qirebox-overlayBG" id="qirebox_overlay"></div><div id="qirebox" class="qirebox png-img"><iframe frameborder="0" class="ui-iframe"></iframe><table class="ui-dialog-box"><tr><td><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-tip alert" id="ui-cnt"><span id="xtip">' +
        oxdefaults.txt +
    ...
    $("#qirebox").fadeIn(500);
    $("#ui-cnt")
      .removeClass("succ error alert loading")
      .addClass(oxdefaults.cssname);
    ...
    if (oxdefaults.isajax == 1) {
      ...
      var idval =
        id.attributes["data"].nodeValue != null &&
        id.attributes["data"].nodeValue != undefined
          ? id.attributes["data"].nodeValue
          : id.data;
      $.ajax({
        url: idval,
        async: true,
    ...
    var floatdiv = $(
      '<div class="qirebox_overlayBG" id="qirebox_overlay"></div><div id="qirebox" class="qirebox"><iframe frameborder="0" class="ui-iframe"></iframe><div class="ui-dialog"><div class="ui-dialog-cnt" id="ui-dialog-cnt"><div class="ui-dialog-box"<div class="ui-cnt" id="ui-cnt">' +
        oxdefaults.txt +
        "</div></div></div></div></div>"
    );
    $("body").append(floatdiv);
...
jQuery.hidediv = function (e) {
  var oxdefaults = { intvaltime: 1500 };
  e = e || {};
  $.extend(oxdefaults, e);
...
(function ($) {
  $.fn.qiresub = function (options) {
    ...
    $.showfloatdiv({ offset: ox, txt: defaults.txt });
    var obj = $(this);
    var id = obj.attr("id");
    return {
      post: function (e) {
          ...
          function (result) {
            ...
            if (result.wantredir != undefined || result.wantredir != null) {
              if (result.redir != undefined || result.redir != null) {
                setTimeout(
                  "$.refresh('" + result.redir + "')",
                  options.intvaltime
                );
              } else {
                setTimeout(
                  "$.refresh('" + options.redirurl + "')",
                  options.intvaltime
                );
              }
            }
