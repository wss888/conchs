...
function stars(r) {
  ...
  var totalnum =
    parseInt(r["data"].vod_gold_1) +
    parseInt(r["data"].vod_gold_2) +
    parseInt(r["data"].vod_gold_3) +
    parseInt(r["data"].vod_gold_4) +
    parseInt(r["data"].vod_gold_5);

  if (totalnum > 0) {
    $("#pam").css(
      "width",
      (parseInt(r["data"].vod_gold_5) / totalnum) * 100 + "%"
    );
    $("#pbm").css(
      "width",
      (parseInt(r["data"].vod_gold_4) / totalnum) * 100 + "%"
    );
    $("#pcm").css(
      "width",
      (parseInt(r["data"].vod_gold_3) / totalnum) * 100 + "%"
    );
    $("#pdm").css(
      "width",
      (parseInt(r["data"].vod_gold_2) / totalnum) * 100 + "%"
    );
    $("#pem").css(
      "width",
      (parseInt(r["data"].vod_gold_1) / totalnum) * 100 + "%"
    );
  }
